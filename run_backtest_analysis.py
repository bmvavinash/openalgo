#!/usr/bin/env python
"""
Backtest Analysis Runner
Runs analysis on sandbox trades to show strategy performance
"""
import sys
import os
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

# Import app first to set up Flask context
from app import app

def run_analysis():
    """Run backtest analysis with Flask app context"""
