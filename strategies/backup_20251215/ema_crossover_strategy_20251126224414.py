...
# Risk management
STOP_LOSS_PCT = risk_config.get('stop_loss_pct', 2.0) if risk_config else 2.0
    ...
    while True:
        try:
            for symbol in SYMBOLS:
                ...
                logger.debug(f"{symbol} - Position: {position_str}, SL: {stop_loss_str}, Fast EMA: {fast_ema_str}, Slow EMA: {slow_ema_str}")
